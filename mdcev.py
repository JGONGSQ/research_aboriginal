...
class ModelRun(object):
    ...
    # CSV data file
    ### Input data ###
    model_data_file = "resources/2012/IVS_2012_MDCEV_ALL_PROCESSED.csv"
    # model_data_file = "resources/2012/filted_data.csv"
    halton_filepath = "resources/Halton/Halton.csv"

    # Constant
    alternative_list = DESTINATION_ALTERNATIVES_LIST

    utility_parameters = ['AUSNITES', 'NUMVISIT', GENDER_STR,
                          AGEGROUP_STR, PARTYPE_STR, PURPOSE_STR, COUNTRY_STR]
    #
    # utility_parameters = ['AUSNITES', 'NUMVISIT', GENDER_STR]

    # alternative_utility_variables = ['GENDER_MALE', 'GENDER_FEMALE', 'PARTYPE_ADULT_COUPLE', 'TRIP_PURPOSE_HOLIDAY']
    alternative_utility_variables = ['GENDER_MALE', 'GENDER_FEMALE']
    # case_config_list = [4]
    case_config_list = [1]
